            ...
            Div(
                Div(
                    Div(
                        ...
                        Div("HPU ON" if b.vbs.hpu_enable else "HPU OFF",
        ...
        def ToggleBlock(label, is_on, state_key):
            ...
            if sc.active:
                if sc.mission_name == "LOADING BALLAST TANK" and state_key in (
                    "hp_ap_on_off",   # Stage 1 — SOP 96: MBS / HP Air Port
                    "hp_bp_on_off",   # Stage 2 — SOP 97: Ready to Dive
                    "dive_in",        # Stage 3 — SOP 98: Dive (7th tank)
                    "vbt_set_value",  # Stage 4 — SOP 99: MBS re-confirm
                    "freeboard_p",    # Stage 5 — SOP 100: Freeboard blow valves
                ):
                    highlight = True
...
async def get(dive_num: int = 1):
    ...
    # The pilot must click START on the Switches tab to begin.
