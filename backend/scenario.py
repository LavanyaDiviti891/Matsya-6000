        ...
        while sc.active and sc.success is None and sc.timer_remaining > 0:
            try:
                ...
                if sc.current_stage == 1:
                    ...
                    await confirm_and_advance("Port Utility voltage validated ", "ub_p", READING_PAUSE_SECS)

                elif sc.current_stage == 12:
                    sc.feedback_msg = "SOP Step 12: Check insulation status of UB_P bus (IR ≥ 1.5 M Ohm)."
                    await confirm_and_advance("Insulation values validated.", None, 3)
                    ...
                    await confirm_and_advance("Turn ON Pilot Panel PC ", None, 4)
                    ...
                    await confirm_and_advance("Insulation status loaded ", "eb_s_ir", READING_PAUSE_SECS)
                    ...
                    await confirm_and_advance("Starboard Utility voltage validated ", "ub_s", READING_PAUSE_SECS)
                    ...
                    sc.feedback_msg = "SOP Step 75: Turn ON toggle switch UW LED_P in general switches at PS."
                    ...
                    sc.feedback_msg = "SOP Step 79: Turn ON toggle switch UW LED_S in general switches at PS."
                    ...
                    await confirm_and_advance("Date, time, and INS data alignment verified.", None, 3)

                elif sc.current_stage == 84:
                    sc.feedback_msg = "SOP Step 84: Turn ON soft control button CTD_P in Sensor page GUI."
                    ...
                    sc.feedback_msg = "SOP Step 85: Turn ON soft control button DO_S in sensor page GUI."
                    ...
                    sc.feedback_msg = "SOP Step 86: Turn ON toggle switch Surface INS"
                    ...
                    sc.feedback_msg = "SOP Step 88: Turn ON toggle switch Redt Depth "
                    ...
                    sc.feedback_msg = "SOP Step 89: Turn ON soft control button INS_P in sensors GUI."
                    ...
                    sc.feedback_msg = "SOP Step 90: Turn ON soft control button DVL_P in sensors page GUI."
                    ...
                    sc.feedback_msg = "SOP Step 91: Turn ON soft control button Altimeter_S in sensors page GUI."
                    ...
                    sc.feedback_msg = "SOP Step 92: Power ON soft button Acoustic modem  in MCC page GUI."
                    ...
                    sc.feedback_msg = "SOP Step 94: Turn ON UWT_PWR "
                    ...
                    sc.feedback_msg = "Phase 1: Inspect Penetrator Plates, then turn ON Dive-In switch "
                ...
                # ─────────────────────────────────────────────────────────────
                    ...
                    thrusters = [getattr(pd, f"t{i}", None) for i in range(1, 9)]
                    if all(getattr(t, "power", False) and getattr(t, "enable", False) for t in thrusters if t is not None):
                ...
                sc.feedback_msg = f"Internal error at Stage {sc.current_stage}: {stage_e}"
                try:
                    await broadcast_fn()
                except Exception:
                    pass
